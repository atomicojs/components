...
function compareContent({ value }) {
  ...
  const onMove = (event) => {
    ...
    if (active) {
      ...
      setPosition({
        x: offsetX < 0 ? 0 : offsetX > rect.width ? 1 : offsetX / rect.width,
        y: offsetY < 0 ? 0 : offsetY > rect.height ? 1 : offsetY / rect.height
      });
    }
  };
  ...
  return /* @__PURE__ */ jsxs("host", { shadowDom: true, children: [
    ...
    /* @__PURE__ */ jsx("style", { children: `
            ...
            ` }),
    /* @__PURE__ */ jsx("div", { class: "split-mask split-content", children: slotItems.map((item, i) => /* @__PURE__ */ jsx("slot", { name: item.slot = `item-${i + 1}` })) }),
    /* @__PURE__ */ jsx("div", { class: "split-mask split-layer", children: /* @__PURE__ */ jsx("div", { class: "split" }) }),
    /* @__PURE__ */ jsx("div", { class: "split-mask split-layer", children: /* @__PURE__ */ jsx("div", { class: "split split-trasparent", children: /* @__PURE__ */ jsx("div", { class: "split-center", ref: refTrigger, children: /* @__PURE__ */ jsx("slot", { name: "trigger", children: /* @__PURE__ */ jsx("button", { class: "split-trigger", children: /* @__PURE__ */ jsx(
      "svg",
      {
        width: "12.001",
        height: "7.999",
